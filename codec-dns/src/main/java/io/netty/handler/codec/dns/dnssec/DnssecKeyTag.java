 ...
 * one. It exists to narrow a candidate set, never to select a key.
 *
 ...
 * signatures it is willing to try, and give up rather than iterate.
 *
 ...
 * Rather than implement a retired algorithm from corrected text, algorithm 1 is rejected.
 */
public final class DnssecKeyTag {
     ...
     * at every call site is both wasteful and a place to get the field widths wrong.
     *
