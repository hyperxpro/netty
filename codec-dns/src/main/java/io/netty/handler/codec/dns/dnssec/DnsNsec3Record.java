...
public final class DnsNsec3Record extends AbstractDnssecRecord {
     ...
     */
    private DnsNsec3Record(DnsNsec3Record record, ByteBuf content) {
    ...
    public DnsNsec3Record copy() {
        return new DnsNsec3Record(this, content().copy());
    }

    @Override
    public DnsNsec3Record duplicate() {
        return new DnsNsec3Record(this, content().duplicate());
    }

    @Override
    public DnsNsec3Record retainedDuplicate() {
        return new DnsNsec3Record(this, content().retainedDuplicate());
    }
